...
import { EditOrderResponse, EditReturnStatus, InitiateReturn, OrderResponse, RefundReturn } from "./orders.type";
...
export const orderApiSlice = apiSlice.injectEndpoints({
    ...
    endpoints: (builder) => ({
        ...
        getEditReturnStatus: builder.mutation<EditReturnStatus, { returnCode: string}>({
            query: ({returnCode}) => ({
